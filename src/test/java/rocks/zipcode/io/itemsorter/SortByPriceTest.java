...
public class SortByPriceTest {
    ...
    public void test2() {
        // given
        Item item1 = new Item(3L, "Apple", 15.0);
        Item item2 = new Item(4L, "Banana", 21.5);
        Item item3 = new Item(5L, "Cherry", 2.0);
        Item[] itemsToSort = {item2, item1, item3};
    ...
    public void test3() {
        ...
        Item item2 = new Item(15L, "Banana", 11.5);
        Item item1 = new Item(16L, "Cherry", 22.0);
        Item[] itemsToSort = {item2, item1, item3};
        Item[] expected = {item3, item2, item1};
        ItemSorter itemSorter = new ItemSorter(itemsToSort);
        Comparator<Item> comparator = (Comparator<Item>) new PriceComparator();
